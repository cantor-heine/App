...
class AnimationController extends Animation<double>
  ...
  ///
  /// `_controller.toggle(condition)` is shorthand for:
  ///
  /// ```dart
  /// if (condition) {
  ///   _controller.forward();
  ...
  /// ```
  ///
  /// If [animateForward] is null, [isForwardOrCompleted] determines the animation
  /// direction. The controller animates to [lowerBound] if the [status] is either
  /// [AnimationStatus.forward] or [AnimationStatus.completed] and animates to
  /// [upperBound] for [AnimationStatus.reverse] or [AnimationStatus.dismissed].
  ///
  /// The most recently returned [TickerFuture], if any, is marked as having been
  /// canceled, meaning the future never completes and its [TickerFuture.orCancel]
  /// derivative future completes with a [TickerCanceled] error.
  TickerFuture toggle([ bool? animateForward ]) {
    return _toggle('toggle', animateForward ?? !isForwardOrCompleted, null);
  }
